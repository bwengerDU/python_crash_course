...
class AlienInvasion():
    ...
    def _update_bullets(self):
        """Update positino of bullets and get rid of old bullets"""
    ...
    def _check_bullet_alien_collisions(self): 
        ...
        #remove the bullets and the aliens that have collided
    ...
    def _update_aliens(self):
        ...
        positions of all aliens in teh fleet."""
        self._check_fleet_edges()
        self.aliens.update()

        #look for alien-on-ship collisions
    ...
    def _create_fleet(self):
        ...
        #Determine the number of rows of aliens tha tfit on the screen
